...
<html>
    <head>
        ...
        <g:set var="entityName" value="request"/> <!--value="${message(code: 'request1.label', default: 'Förfrågan')}"--> 
...
<!--<g:formatNumber number="${request1?.thickness}" format="###,##0"  locale="sv_SE"/>  -->
                ...
                <tr>
                <td>
                    Contactperson:  <g:field type="text" name="contactPerson" required="y" value="${request1?.contactPerson}" size="50"/>
                </td>
                <td>
