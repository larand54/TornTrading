...
class BootStrap {
	...
	if (Environment.current == Environment.DEVELOPMENT) {
            ...
            def pb = new ProdBuffer(sawMill:'Boda',product:'38x125 o/s, Furu', length:4200, volumeAvailable: 500, volumeOffered: 500, onOrder: 450, volumeRest: 50, volumeRestInclOffers: -450, currency: 'EUR', price: '25,5', weekStart: '1704', weekEnd: '1709', status: 'Preliminary', volumeUnit: 'AM3', availW01:500, availW02:500, availW03:450, availW04:450, availW05:350, availW06:350, availW07:350, availW08:350, availW09:350, availW10:350).save(failOnError: true)
	...
	if (Environment.current == Environment.PRODUCTION) {
            ...
            new ProdBuffer(sawMill:'Boda',product:'38x125 o/s, Furu', length:'3800mm', volumeAvailable: 500, volumeOffered: 500, volumeBooked: 200, volumeRest: 300, currency: 'SEK', price: 255.5, weekStart: '1708', weekEnd: '1712', status: 'Preliminär', volumeUnit: 'AM3', availW01:500, availW02:500, availW03:450, availW04:450, availW05:350, availW06:350, availW07:350, availW08:350, availW09:350, availW10:350).save()
            ...
            def supplierUser1 = new User(userName: 'supplier1', password: 'supplier1').save()
            def supplierUser2 = new User(userName: 'supplier2', password: 'supplier2').save()
            def supplierUser3 = new User(userName: 'supplier3', password: 'supplier3').save()
